...
build:
	xcodebuild clean build -scheme autoresponsive_react_native_sample -sdk iphonesimulator9.3 -configuration Release CODE_SIGNING_REQUIRED=NO CODE_SIGN_IDENTITY=""
