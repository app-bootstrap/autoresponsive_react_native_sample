...
build:
	xcodebuild clean build -scheme autoresponsive_react_native_sample -sdk iphonesimulator9.3 -configuration Debug -arch i386 CODE_SIGNING_REQUIRED=NO CODE_SIGN_IDENTITY=""
