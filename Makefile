...
build:
	xcodebuild clean build -scheme autoresponsive_react_native_sample -configuration Release -sdk iphonesimulator9.3 CODE_SIGNING_REQUIRED=NO CODE_SIGN_IDENTITY=""
